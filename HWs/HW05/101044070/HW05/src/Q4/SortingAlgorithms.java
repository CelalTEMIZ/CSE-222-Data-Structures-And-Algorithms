...
/**
 * 4 sort algorithms from the course book.
 */
public class SortingAlgorithms {
     ...
     */
    public static < T
            extends Comparable < T >> void insertionSort(T[] table) {
     ...
     */
    public static < T
            extends Comparable < T >> void mergeSort(T[] table) {
     ...
     */
    public static < T
            extends Comparable < T >> void heapSort(T[] table) {
        buildHeap(table);
